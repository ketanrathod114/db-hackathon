  ...
  render () {
    return (
      <nav className="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <h2>Dementia</h2>
          {/* <Link className="navbar-brand brand-logo" to="/"><img src={require('../../assets/images/logo.svg')} alt="logo" /> Dementia</Link>
          <Link className="navbar-brand brand-logo-mini" to="/"><img src={require('../../assets/images/logo-mini.svg')} alt="logo" />Dementia</Link> */}
        </div>
              ...
              <Dropdown alignRight>
                <Dropdown.Toggle className="nav-link">
                  ...
                  <div className="nav-profile-text">
                    <p className="mb-1 text-black"><Trans>Deutsche Bank</Trans></p>
                  </div>
                </Dropdown.Toggle>
